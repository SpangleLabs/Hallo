...
def test_long_simple(hallo_getter):
    ...
    hallo.function_dispatcher.dispatch(EventMessage(test_server, None, test_user, "longcat"))
...
def test_long_long(hallo_getter):
    ...
    hallo.function_dispatcher.dispatch(EventMessage(test_server, None, test_user, "longcat 10"))
    data = test_server.get_send_data()
