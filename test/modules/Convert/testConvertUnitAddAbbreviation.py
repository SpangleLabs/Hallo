...
class ConvertUnitAddAbbreviationTest(ConvertFunctionTestBase, unittest.TestCase):
    ...
    def test_specify_invalid_type(self):
        ...
        assert len(self.test_unit1a.abbr_list) == 0, "Shouldn't have added abbreviation"
    ...
    def test_specified_unit_wrong(self):
        ...
        assert len(self.test_unit1a.abbr_list) == 0, "Shouldn't have added abbreviation anywhere"
        assert len(self.test_unit1b.abbr_list) == 0, "Shouldn't have added abbreviation anywhere"
    ...
    def test_specified_unit_ambiguous(self):
        ...
        assert len(self.test_unit1b.abbr_list) == 0, "Shouldn't have added abbreviation anywhere"
        assert len(self.test_unit2b.abbr_list) == 0, "Shouldn't have added abbreviation anywhere"
    ...
    def test_specified_unit_ambiguous_but_type_specified(self):
        ...
        assert len(self.test_unit1b.abbr_list) == 1, "Should have added abbreviation to type1 same_name"
        assert self.test_unit1b.abbr_list[0] == "abbr"
        assert len(self.test_unit2b.abbr_list) == 0, "Shouldn't have added abbreviation to type2 same_name"
    ...
    def test_specified_abbreviation(self):
        ...
        assert len(self.test_unit1a.abbr_list) == 1, "Should have added abbreviation to unit1a"
        assert self.test_unit1a.abbr_list[0] == "u1a"
        assert len(self.test_unit1b.abbr_list) == 0, "Shouldn't have added abbreviation to unit1b"
        assert len(self.test_unit2a.abbr_list) == 0, "Shouldn't have added abbreviation to unit2a"
        assert len(self.test_unit2b.abbr_list) == 0, "Shouldn't have added abbreviation to unit2b"
    ...
    def test_multi_word_ambiguous(self):
        ...
        assert len(self.test_unit1a.abbr_list) == 0, "Shouldn't have added abbreviation to unit1a"
        assert len(self.test_unit1b.abbr_list) == 0, "Shouldn't have added abbreviation to unit1b"
    ...
    def test_no_abbreviation(self):
        ...
        assert len(self.test_unit1a.abbr_list) == 0, "Shouldn't have added any abbreviation to unit1a"
