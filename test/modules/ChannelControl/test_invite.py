...
def test_invite_1priv_not_known(hallo_getter):
    ...
    chan1_hallo.is_op = True
    try:
        hallo.function_dispatcher.dispatch(EventMessage(serv1, None, user1, "invite other_channel"))
...
def test_invite_1priv_not_in_channel(hallo_getter):
    ...
    chan1_hallo.is_op = True
    try:
        hallo.function_dispatcher.dispatch(EventMessage(serv1, None, user1, "invite test_chan2"))
        data = serv1.get_send_data(1, user1, EventMessage)
        assert "error" in data[0].text.lower()
...
def test_invite_1priv_user_already_there(hallo_getter):
    ...
    chan1_hallo.is_op = True
    try:
        hallo.function_dispatcher.dispatch(EventMessage(serv1, None, user1, "invite test_chan1"))
        data = serv1.get_send_data(1, user1, EventMessage)
        assert "error" in data[0].text.lower()
...
def test_invite_1_chan_user_already_there(hallo_getter):
    ...
    try:
        hallo.function_dispatcher.dispatch(EventMessage(serv1, chan1, user1, "invite test_chan2"))
        data = serv1.get_send_data(1, chan1, EventMessage)
        assert "error" in data[0].text.lower()
...
def test_invite_1_user_already_here(hallo_getter):
    ...
    try:
        hallo.function_dispatcher.dispatch(EventMessage(serv1, chan1, user1, "invite test_user2"))
        data = serv1.get_send_data(1, chan1, EventMessage)
        assert "error" in data[0].text.lower()
...
def test_invite_2_chan_user_already_there(hallo_getter):
    ...
    chan2_hallo.is_op = True
    try:
        hallo.function_dispatcher.dispatch(EventMessage(serv1, chan1, user1, "invite test_chan2 test_user2"))
        data = serv1.get_send_data(1, chan1, EventMessage)
        assert "error" in data[0].text.lower()
...
def test_invite_2_user_not_in_channel(hallo_getter):
    ...
    chan2_user1.is_op = False
    try:
        hallo.function_dispatcher.dispatch(EventMessage(serv1, chan1, user1, "invite test_user2 test_chan2"))
        data = serv1.get_send_data(1, chan1, EventMessage)
        assert "error" in data[0].text.lower()
