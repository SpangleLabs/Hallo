...
class DeVoiceTest(TestBase, unittest.TestCase):
    ...
    def test_devoice_not_irc(self):
        ...
        try:
            self.function_dispatcher.dispatch("devoice", user1, chan1)
    ...
    def test_devoice_0_privmsg(self):
        ...
        chan1.add_user(serv1.get_user_by_address(serv1.get_nick().lower(), serv1.get_nick()))
        try:
            self.function_dispatcher.dispatch("devoice", user1, user1)
    ...
    def test_devoice_0_not_voice(self):
        ...
        try:
            ...
            data = serv1.get_send_data(1, chan1, Server.MSG_MSG)
            assert "error" in data[0][0].lower()
            assert "doesn't have voice" in data[0][0].lower()
        finally:
            self.hallo.remove_server(serv1)
    ...
    def test_devoice_1priv_not_known(self):
        ...
        chan1_hallo.is_op = True
        try:
            self.function_dispatcher.dispatch("devoice other_channel", user1, user1)
            data = serv1.get_send_data(1, user1, Server.MSG_MSG)
            assert "error" in data[0][0].lower()
    ...
    def test_devoice_1priv_not_in_channel(self):
        ...
        chan1_hallo.is_op = True
        try:
            self.function_dispatcher.dispatch("devoice test_chan2", user1, user1)
            data = serv1.get_send_data(1, user1, Server.MSG_MSG)
            assert "error" in data[0][0].lower()
    ...
    def test_devoice_1priv_user_not_there(self):
        ...
        chan1_hallo.is_op = True
        try:
            self.function_dispatcher.dispatch("devoice test_chan1", user1, user1)
            data = serv1.get_send_data(1, user1, Server.MSG_MSG)
            assert "error" in data[0][0].lower()
    ...
    def test_devoice_1_chan_user_not_there(self):
        ...
        try:
            self.function_dispatcher.dispatch("devoice test_chan2", user1, chan1)
            data = serv1.get_send_data(1, chan1, Server.MSG_MSG)
            assert "error" in data[0][0].lower()
    ...
    def test_devoice_1_user_not_here(self):
        ...
        chan1_hallo.is_op = True
        try:
            self.function_dispatcher.dispatch("devoice test_user2", user1, chan1)
            data = serv1.get_send_data(1, chan1, Server.MSG_MSG)
            assert "error" in data[0][0].lower()
    ...
    def test_devoice_2_chan_user_not_known(self):
        ...
        chan2_hallo.is_op = True
        try:
            self.function_dispatcher.dispatch("devoice test_chan2 test_user3", user1, chan1)
            data = serv1.get_send_data(1, chan1, Server.MSG_MSG)
            assert "error" in data[0][0].lower()
    ...
    def test_devoice_2_chan_no_power(self):
        ...
        chan2_hallo.is_op = False
        try:
            self.function_dispatcher.dispatch("devoice test_chan2 test_user2", user1, chan1)
            data = serv1.get_send_data(1, chan1, Server.MSG_MSG)
            assert "error" in data[0][0].lower()
            assert "don't have power" in data[0][0].lower()
        finally:
    ...
    def test_devoice_2_user_not_in_channel(self):
        ...
        chan2_user1.is_op = False
        try:
            self.function_dispatcher.dispatch("devoice test_user2 test_chan2", user1, chan1)
            data = serv1.get_send_data(1, chan1, Server.MSG_MSG)
            assert "error" in data[0][0].lower()
    ...
    def test_devoice_2_user_user_not_known(self):
        ...
        chan2_hallo.is_op = True
        try:
            self.function_dispatcher.dispatch("devoice test_user3 test_chan2", user1, chan1)
            data = serv1.get_send_data(1, chan1, Server.MSG_MSG)
            assert "error" in data[0][0].lower()
            assert "test_user3 is not known" in data[0][0].lower()
        finally:
