...
class VoiceTest(TestBase, unittest.TestCase):

    def test_voice_not_irc(self):
    ...
    def test_voice_0_is_voice(self):
        serv1 = ServerMock(self.hallo)
        serv1.name = "test_serv1"
        serv1.type = Server.TYPE_IRC
        self.hallo.add_server(serv1)
    ...
    def test_voice_1priv_not_known(self):
        serv1 = ServerMock(self.hallo)
        serv1.name = "test_serv1"
        serv1.type = Server.TYPE_IRC
        self.hallo.add_server(serv1)
        ...
        chan1_hallo.is_op = True
        try:
            self.function_dispatcher.dispatch("voice other_channel", user1, user1)
            data = serv1.get_send_data(1, user1, Server.MSG_MSG)
            assert "error" in data[0][0].lower()
    ...
    def test_voice_1priv_not_in_channel(self):
        serv1 = ServerMock(self.hallo)
        serv1.name = "test_serv1"
        serv1.type = Server.TYPE_IRC
        self.hallo.add_server(serv1)
    ...
    def test_voice_1priv_user_not_there(self):
        ...
        chan1_hallo.is_op = True
        try:
            self.function_dispatcher.dispatch("voice test_chan1", user1, user1)
            data = serv1.get_send_data(1, user1, Server.MSG_MSG)
            assert "error" in data[0][0].lower()
    ...
    def test_voice_1priv_no_power(self):
        serv1 = ServerMock(self.hallo)
        serv1.name = "test_serv1"
        serv1.type = Server.TYPE_IRC
        self.hallo.add_server(serv1)
    ...
    def test_voice_1priv_is_voice(self):
        serv1 = ServerMock(self.hallo)
        serv1.name = "test_serv1"
        serv1.type = Server.TYPE_IRC
        self.hallo.add_server(serv1)
    ...
    def test_voice_1priv_is_op(self):
        serv1 = ServerMock(self.hallo)
        serv1.name = "test_serv1"
        serv1.type = Server.TYPE_IRC
        self.hallo.add_server(serv1)
    ...
    def test_voice_1_chan_user_not_there(self):
        serv1 = ServerMock(self.hallo)
        serv1.name = "test_serv1"
        serv1.type = Server.TYPE_IRC
        self.hallo.add_server(serv1)
        ...
        try:
            self.function_dispatcher.dispatch("voice test_chan2", user1, chan1)
            data = serv1.get_send_data(1, chan1, Server.MSG_MSG)
            assert "error" in data[0][0].lower()
    ...
    def test_voice_1_chan_no_power(self):
        serv1 = ServerMock(self.hallo)
        serv1.name = "test_serv1"
        serv1.type = Server.TYPE_IRC
        self.hallo.add_server(serv1)
    ...
    def test_voice_1_chan_is_voice(self):
        serv1 = ServerMock(self.hallo)
        serv1.name = "test_serv1"
        serv1.type = Server.TYPE_IRC
        self.hallo.add_server(serv1)
    ...
    def test_voice_1_chan_is_op(self):
        serv1 = ServerMock(self.hallo)
        serv1.name = "test_serv1"
        serv1.type = Server.TYPE_IRC
        self.hallo.add_server(serv1)
    ...
    def test_voice_1_user_not_here(self):
        serv1 = ServerMock(self.hallo)
        serv1.name = "test_serv1"
        serv1.type = Server.TYPE_IRC
        self.hallo.add_server(serv1)
    ...
    def test_voice_1_user_no_power(self):
        serv1 = ServerMock(self.hallo)
        serv1.name = "test_serv1"
        serv1.type = Server.TYPE_IRC
        self.hallo.add_server(serv1)
    ...
    def test_voice_1_user_is_op(self):
        serv1 = ServerMock(self.hallo)
        serv1.name = "test_serv1"
        serv1.type = Server.TYPE_IRC
        self.hallo.add_server(serv1)
    ...
    def test_voice_2_chan_user_not_known(self):
        serv1 = ServerMock(self.hallo)
        serv1.name = "test_serv1"
        serv1.type = Server.TYPE_IRC
        self.hallo.add_server(serv1)
        ...
        chan2_hallo.is_op = True
        try:
            self.function_dispatcher.dispatch("voice test_chan2 test_user3", user1, chan1)
            data = serv1.get_send_data(1, chan1, Server.MSG_MSG)
            assert "error" in data[0][0].lower()
    ...
    def test_voice_2_chan_user_not_there(self):
        serv1 = ServerMock(self.hallo)
        serv1.name = "test_serv1"
        serv1.type = Server.TYPE_IRC
        self.hallo.add_server(serv1)
    ...
    def test_voice_2_chan_no_power(self):
        serv1 = ServerMock(self.hallo)
        serv1.name = "test_serv1"
        serv1.type = Server.TYPE_IRC
        self.hallo.add_server(serv1)
        ...
        chan2_hallo.is_op = False
        try:
            self.function_dispatcher.dispatch("voice test_chan2 test_user2", user1, chan1)
            data = serv1.get_send_data(1, chan1, Server.MSG_MSG)
            assert "error" in data[0][0].lower()
            assert "don't have power" in data[0][0].lower()
        finally:
    ...
    def test_voice_2_chan_is_voice(self):
        serv1 = ServerMock(self.hallo)
        serv1.name = "test_serv1"
        serv1.type = Server.TYPE_IRC
        self.hallo.add_server(serv1)
    ...
    def test_voice_2_chan_is_op(self):
        serv1 = ServerMock(self.hallo)
        serv1.name = "test_serv1"
        serv1.type = Server.TYPE_IRC
        self.hallo.add_server(serv1)
    ...
    def test_voice_2_user_not_in_channel(self):
        serv1 = ServerMock(self.hallo)
        serv1.name = "test_serv1"
        serv1.type = Server.TYPE_IRC
        self.hallo.add_server(serv1)
        ...
        chan2_user1.is_op = False
        try:
            self.function_dispatcher.dispatch("voice test_user2 test_chan2", user1, chan1)
            data = serv1.get_send_data(1, chan1, Server.MSG_MSG)
            assert "error" in data[0][0].lower()
    ...
    def test_voice_2_user_user_not_known(self):
        serv1 = ServerMock(self.hallo)
        serv1.name = "test_serv1"
        serv1.type = Server.TYPE_IRC
        self.hallo.add_server(serv1)
        ...
        chan2_hallo.is_op = True
        try:
            self.function_dispatcher.dispatch("voice test_user3 test_chan2", user1, chan1)
            data = serv1.get_send_data(1, chan1, Server.MSG_MSG)
            assert "error" in data[0][0].lower()
            assert "test_user3 is not known" in data[0][0].lower()
        finally:
    ...
    def test_voice_2_user_user_not_there(self):
        serv1 = ServerMock(self.hallo)
        serv1.name = "test_serv1"
        serv1.type = Server.TYPE_IRC
        self.hallo.add_server(serv1)
    ...
    def test_voice_2_user_no_power(self):
        serv1 = ServerMock(self.hallo)
        serv1.name = "test_serv1"
        serv1.type = Server.TYPE_IRC
        self.hallo.add_server(serv1)
    ...
    def test_voice_2_user_is_voice(self):
        serv1 = ServerMock(self.hallo)
        serv1.name = "test_serv1"
        serv1.type = Server.TYPE_IRC
        self.hallo.add_server(serv1)
    ...
    def test_voice_2_user_is_op(self):
        serv1 = ServerMock(self.hallo)
        serv1.name = "test_serv1"
        serv1.type = Server.TYPE_IRC
        self.hallo.add_server(serv1)
