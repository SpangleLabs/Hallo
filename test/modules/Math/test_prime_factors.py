...
def test_factors_simple(hallo_getter):
    ...
    hallo.function_dispatcher.dispatch(EventMessage(test_server, None, test_user, "factors 6"))
...
def test_factors_big(hallo_getter):
    hallo, test_server, test_channel, test_user = hallo_getter({"math"})
    hallo.function_dispatcher.dispatch(EventMessage(test_server, None, test_user, "factors 295228"))
    data = test_server.get_send_data(1, test_user, EventMessage)
...
def test_factors_negative(hallo_getter):
    hallo, test_server, test_channel, test_user = hallo_getter({"math"})
    hallo.function_dispatcher.dispatch(EventMessage(test_server, None, test_user, "factors -17"))
    data = test_server.get_send_data(1, test_user, EventMessage)
...
def test_factors_float(hallo_getter):
    hallo, test_server, test_channel, test_user = hallo_getter({"math"})
    hallo.function_dispatcher.dispatch(EventMessage(test_server, None, test_user, "factors 17.5"))
    data = test_server.get_send_data(1, test_user, EventMessage)
...
def test_factors_prime(hallo_getter):
    hallo, test_server, test_channel, test_user = hallo_getter({"math"})
    hallo.function_dispatcher.dispatch(EventMessage(test_server, None, test_user, "factors 104779"))
    data = test_server.get_send_data(1, test_user, EventMessage)
...
def test_factors_fail(hallo_getter):
    hallo, test_server, test_channel, test_user = hallo_getter({"math"})
    hallo.function_dispatcher.dispatch(EventMessage(test_server, None, test_user, "factors seventeen"))
    data = test_server.get_send_data(1, test_user, EventMessage)
...
def test_factors_calc_division(hallo_getter):
    hallo, test_server, test_channel, test_user = hallo_getter({"math"})
    hallo.function_dispatcher.dispatch(EventMessage(test_server, None, test_user, "factors 232234/83"))
    data = test_server.get_send_data(1, test_user, EventMessage)
...
def test_factors_calc_float(hallo_getter):
    hallo, test_server, test_channel, test_user = hallo_getter({"math"})
    hallo.function_dispatcher.dispatch(EventMessage(test_server, None, test_user, "factors 232234/80"))
    data = test_server.get_send_data(1, test_user, EventMessage)
