...
class ConvertUnitAddNameTest(ConvertFunctionTestBase, unittest.TestCase):
    ...
    def test_specified_unit_ambiguous(self):
        ...
        assert len(self.test_unit1b.name_list) == names_1b, "Shouldn't have added new name anywhere"
        assert len(self.test_unit2b.name_list) == names_2b, "Shouldn't have added new name anywhere"
    ...
    def test_specified_unit_ambiguous_but_type_specified(self):
        ...
        assert len(self.test_unit1b.name_list) == names_1b + 1, "Should have added new name to type1 same_name"
        assert "new_name" in self.test_unit1b.name_list
        assert len(self.test_unit2b.name_list) == names_2b, "Shouldn't have added new name to type2 same_name"
    ...
    def test_multi_word_ambiguous(self):
        ...
        assert len(self.test_unit1a.name_list) == names_1a, "Shouldn't have added new name to unit1a"
        assert len(self.test_unit1b.name_list) == names_1b, "Shouldn't have added new name to unit1b"
