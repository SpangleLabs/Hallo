...
class ConvertViewRepoTest(ConvertFunctionTestBase, unittest.TestCase):
    def setUp(self):
        ...
        modules.convert.ConvertViewRepo.output_repo_as_string = (
            self.mock_view_repo.method
        )
        modules.convert.ConvertViewRepo.output_type_as_string = (
            self.mock_view_type.method
        )
        modules.convert.ConvertViewRepo.output_unit_as_string = (
            self.mock_view_unit.method
        )
        modules.convert.ConvertViewRepo.output_prefix_group_as_string = (
            self.mock_view_group.method
        )
        modules.convert.ConvertViewRepo.output_prefix_as_string = (
