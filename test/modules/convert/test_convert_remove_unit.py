...
class ConvertRemoveUnitTest(ConvertFunctionTestBase, unittest.TestCase):
    ...
    def test_multiple_matching_units(self):
        ...
        assert len(self.test_type1.unit_list) == type1_units, "Shouldn't have removed the unit from type1"
        assert len(self.test_type2.unit_list) == type2_units, "Shouldn't have removed the unit from type2"
