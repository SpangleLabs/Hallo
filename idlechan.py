...
class idlechan():
    ...
    def fnn_chat_to_s(self,args,client,destination):
        'chats to _S'
        messages = ['so, how are things?','is your end of the world holding up ok?',"let's talk about deer!","boop","beep","I'll be honest, this place is dead","Fuck snow","I guess everyone's asleep","clap... clap... *clap*","I'm watching you, robot.","What's with all the deer-rape?","What do you think of that D000242 guy?","What do you think of that spangle kid?","Butts.","I choose you!","How old are you in milli-Americas?"]
