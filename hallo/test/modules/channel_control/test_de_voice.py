...
async def test_devoice_not_irc(hallo_getter):
    ...
    try:
        await test_hallo.function_dispatcher.dispatch(EventMessage(serv1, chan1, user1, "devoice"))
...
async def test_devoice_0_privmsg(hallo_getter):
    test_hallo = await hallo_getter({"channel_control"})
    serv1 = ServerMock(test_hallo)
    serv1.name = "test_serv1"
    ...
    try:
        await test_hallo.function_dispatcher.dispatch(EventMessage(serv1, None, user1, "devoice"))
...
async def test_devoice_0_no_power(hallo_getter):
    test_hallo = await hallo_getter({"channel_control"})
    serv1 = ServerMock(test_hallo)
    serv1.name = "test_serv1"
    serv1.type = Server.TYPE_IRC
...
async def test_devoice_0_not_voice(hallo_getter):
    test_hallo = await hallo_getter({"channel_control"})
    serv1 = ServerMock(test_hallo)
    serv1.name = "test_serv1"
    serv1.type = Server.TYPE_IRC
...
async def test_devoice_0(hallo_getter):
    test_hallo = await hallo_getter({"channel_control"})
    serv1 = ServerMock(test_hallo)
    serv1.name = "test_serv1"
    serv1.type = Server.TYPE_IRC
...
async def test_devoice_1priv_not_known(hallo_getter):
    test_hallo = await hallo_getter({"channel_control"})
    serv1 = ServerMock(test_hallo)
    serv1.name = "test_serv1"
    serv1.type = Server.TYPE_IRC
...
async def test_devoice_1priv_not_in_channel(hallo_getter):
    test_hallo = await hallo_getter({"channel_control"})
    serv1 = ServerMock(test_hallo)
    serv1.name = "test_serv1"
    serv1.type = Server.TYPE_IRC
    test_hallo.add_server(serv1)
    chan1 = await serv1.get_channel_by_address("test_chan1".lower(), "test_chan1")
    await serv1.get_channel_by_address("test_chan2", "test_chan2")
    user1 = serv1.get_user_by_address("test_user1".lower(), "test_user1")
    user_hallo = serv1.get_user_by_address(serv1.get_nick().lower(), serv1.get_nick())
    chan1.add_user(user1)
    chan1.add_user(user_hallo)
...
async def test_devoice_1priv_user_not_there(hallo_getter):
    test_hallo = await hallo_getter({"channel_control"})
    serv1 = ServerMock(test_hallo)
    serv1.name = "test_serv1"
    serv1.type = Server.TYPE_IRC
...
async def test_devoice_1priv_no_power(hallo_getter):
    test_hallo = await hallo_getter({"channel_control"})
    serv1 = ServerMock(test_hallo)
    serv1.name = "test_serv1"
    serv1.type = Server.TYPE_IRC
...
async def test_devoice_1priv_not_voice(hallo_getter):
    test_hallo = await hallo_getter({"channel_control"})
    serv1 = ServerMock(test_hallo)
    serv1.name = "test_serv1"
    serv1.type = Server.TYPE_IRC
...
async def test_devoice_1priv(hallo_getter):
    test_hallo = await hallo_getter({"channel_control"})
    serv1 = ServerMock(test_hallo)
    serv1.name = "test_serv1"
    serv1.type = Server.TYPE_IRC
...
async def test_devoice_1_chan_user_not_there(hallo_getter):
    test_hallo = await hallo_getter({"channel_control"})
    serv1 = ServerMock(test_hallo)
    serv1.name = "test_serv1"
    serv1.type = Server.TYPE_IRC
...
async def test_devoice_1_chan_no_power(hallo_getter):
    test_hallo = await hallo_getter({"channel_control"})
    serv1 = ServerMock(test_hallo)
    serv1.name = "test_serv1"
    serv1.type = Server.TYPE_IRC
...
async def test_devoice_1_chan_not_voice(hallo_getter):
    test_hallo = await hallo_getter({"channel_control"})
    serv1 = ServerMock(test_hallo)
    serv1.name = "test_serv1"
    serv1.type = Server.TYPE_IRC
...
async def test_devoice_1_chan(hallo_getter):
    test_hallo = await hallo_getter({"channel_control"})
    serv1 = ServerMock(test_hallo)
    serv1.name = "test_serv1"
    serv1.type = Server.TYPE_IRC
...
async def test_devoice_1_user_not_here(hallo_getter):
    test_hallo = await hallo_getter({"channel_control"})
    serv1 = ServerMock(test_hallo)
    serv1.name = "test_serv1"
    serv1.type = Server.TYPE_IRC
...
async def test_devoice_1_user_no_power(hallo_getter):
    test_hallo = await hallo_getter({"channel_control"})
    serv1 = ServerMock(test_hallo)
    serv1.name = "test_serv1"
    serv1.type = Server.TYPE_IRC
...
async def test_devoice_1_user_not_voice(hallo_getter):
    test_hallo = await hallo_getter({"channel_control"})
    serv1 = ServerMock(test_hallo)
    serv1.name = "test_serv1"
    serv1.type = Server.TYPE_IRC
...
async def test_devoice_1_user(hallo_getter):
    test_hallo = await hallo_getter({"channel_control"})
    serv1 = ServerMock(test_hallo)
    serv1.name = "test_serv1"
    serv1.type = Server.TYPE_IRC
...
async def test_devoice_2_chan_user_not_known(hallo_getter):
    test_hallo = await hallo_getter({"channel_control"})
    serv1 = ServerMock(test_hallo)
    serv1.name = "test_serv1"
    serv1.type = Server.TYPE_IRC
...
async def test_devoice_2_chan_user_not_there(hallo_getter):
    test_hallo = await hallo_getter({"channel_control"})
    serv1 = ServerMock(test_hallo)
    serv1.name = "test_serv1"
    serv1.type = Server.TYPE_IRC
...
async def test_devoice_2_chan_no_power(hallo_getter):
    test_hallo = await hallo_getter({"channel_control"})
    serv1 = ServerMock(test_hallo)
    serv1.name = "test_serv1"
    serv1.type = Server.TYPE_IRC
...
async def test_devoice_2_chan_not_voice(hallo_getter):
    test_hallo = await hallo_getter({"channel_control"})
    serv1 = ServerMock(test_hallo)
    serv1.name = "test_serv1"
    serv1.type = Server.TYPE_IRC
...
async def test_devoice_2_chan(hallo_getter):
    test_hallo = await hallo_getter({"channel_control"})
    serv1 = ServerMock(test_hallo)
    serv1.name = "test_serv1"
    serv1.type = Server.TYPE_IRC
...
async def test_devoice_2_user_not_in_channel(hallo_getter):
    test_hallo = await hallo_getter({"channel_control"})
    serv1 = ServerMock(test_hallo)
    serv1.name = "test_serv1"
    serv1.type = Server.TYPE_IRC
...
async def test_devoice_2_user_user_not_known(hallo_getter):
    test_hallo = await hallo_getter({"channel_control"})
    serv1 = ServerMock(test_hallo)
    serv1.name = "test_serv1"
    serv1.type = Server.TYPE_IRC
...
async def test_devoice_2_user_user_not_there(hallo_getter):
    test_hallo = await hallo_getter({"channel_control"})
    serv1 = ServerMock(test_hallo)
    serv1.name = "test_serv1"
    serv1.type = Server.TYPE_IRC
...
async def test_devoice_2_user_no_power(hallo_getter):
    test_hallo = await hallo_getter({"channel_control"})
    serv1 = ServerMock(test_hallo)
    serv1.name = "test_serv1"
    serv1.type = Server.TYPE_IRC
...
async def test_devoice_2_user_not_voice(hallo_getter):
    test_hallo = await hallo_getter({"channel_control"})
    serv1 = ServerMock(test_hallo)
    serv1.name = "test_serv1"
    serv1.type = Server.TYPE_IRC
...
async def test_devoice_2_user(hallo_getter):
    test_hallo = await hallo_getter({"channel_control"})
    serv1 = ServerMock(test_hallo)
    serv1.name = "test_serv1"
    serv1.type = Server.TYPE_IRC
