...
async def test_voice_not_irc(hallo_getter):
    ...
    try:
        await test_hallo.function_dispatcher.dispatch(EventMessage(serv1, chan1, user1, "voice"))
...
async def test_voice_0_privmsg(hallo_getter):
    ...
    try:
        await test_hallo.function_dispatcher.dispatch(EventMessage(serv1, None, user1, "voice"))
