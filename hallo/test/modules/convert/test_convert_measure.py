from hallo.modules.convert.convert_repo import ConvertRepo, ConvertType, ConvertUnit, ConvertMeasure, \
...
def test_build_list_from_user_input_start():
    # Setup test objects
    test_repo = ConvertRepo()
    test_type = ConvertType(test_repo, "test_type")
    test_type.base_unit = ConvertUnit(test_type, ["base_unit"], 1)
...
def test_build_list_from_user_input_middle():
    # Setup test objects
    test_repo = ConvertRepo()
    test_type = ConvertType(test_repo, "test_type")
    test_type.base_unit = ConvertUnit(test_type, ["base_unit"], 1)
