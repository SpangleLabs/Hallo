...
def test_json():
    ...
    json_unit = ConvertUnit.from_json(test_type, json_data, )
...
def test_get_prefix_from_user_input_name():
    # Set up prefix group
    test_repo = ConvertRepo()
    prefix_group = ConvertPrefixGroup(test_repo, "test_group")
...
def test_get_prefix_from_user_input_name_internal():
    # Set up prefix group
    test_repo = ConvertRepo()
    prefix_group = ConvertPrefixGroup(test_repo, "test_group")
    prefix_name1 = "test_name1"
...
def test_get_prefix_from_user_input_abbr_internal():
    # Set up prefix group
    test_repo = ConvertRepo()
    prefix_group = ConvertPrefixGroup(test_repo, "test_group")
    prefix_name1 = "test_name1"
