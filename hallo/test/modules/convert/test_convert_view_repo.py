...
class ConvertViewRepoTest(ConvertFunctionTestBase, unittest.TestCase):
    ...
    async def test_specified_type_invalid(self):
    ...
    async def test_type_specified_unit_incorrect(self):
        await self.function_dispatcher.dispatch(
            EventMessage(
                self.server,
                None,
    ...
    async def test_type_specified_unit_different_type(self):
        await self.function_dispatcher.dispatch(
            EventMessage(
                self.server,
                None,
    ...
    async def test_type_and_unit_specified(self):
        await self.function_dispatcher.dispatch(
            EventMessage(
                self.server,
                None,
    ...
    async def test_type_specified(self):
        await self.function_dispatcher.dispatch(
            EventMessage(
    ...
    async def test_specified_group_invalid(self):
        await self.function_dispatcher.dispatch(
            EventMessage(
    ...
    async def test_group_specified_prefix_incorrect(self):
        await self.function_dispatcher.dispatch(
            EventMessage(
                self.server,
                None,
    ...
    async def test_group_specified_prefix_different_group(self):
        await self.function_dispatcher.dispatch(
            EventMessage(
                self.server,
                None,
    ...
    async def test_group_and_prefix_specified(self):
        await self.function_dispatcher.dispatch(
            EventMessage(
                self.server,
                None,
    ...
    async def test_group_and_prefix_abbr_specified(self):
        await self.function_dispatcher.dispatch(
            EventMessage(
                self.server,
                None,
    ...
    async def test_group_specified(self):
        await self.function_dispatcher.dispatch(
            EventMessage(
    ...
    async def test_specified_unit_incorrect(self):
        await self.function_dispatcher.dispatch(
            EventMessage(
    ...
    async def test_specified_unit_multiple(self):
        await self.function_dispatcher.dispatch(
            EventMessage(
    ...
    async def test_unit_specified(self):
        await self.function_dispatcher.dispatch(
            EventMessage(
    ...
    async def test_specified_prefix_incorrect(self):
        await self.function_dispatcher.dispatch(
            EventMessage(
    ...
    async def test_specified_prefix_multiple(self):
        await self.function_dispatcher.dispatch(
            EventMessage(
    ...
    async def test_prefix_specified(self):
        await self.function_dispatcher.dispatch(
            EventMessage(
    ...
    async def test_nothing_specified(self):
        await self.function_dispatcher.dispatch(
