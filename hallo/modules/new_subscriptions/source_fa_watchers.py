...
class FAUserWatchersSource(
    hallo.modules.new_subscriptions.stream_source.StreamSource[
        hallo.modules.new_subscriptions.common_fa_key.FAKey.FAReader.FAWatch
    ]
):
    names: List[str] = [
        "fa user watchers",
    ...
    def __init__(self, fa_key: hallo.modules.new_subscriptions.common_fa_key.FAKey, username: str,
                 last_keys: Optional[List[hallo.modules.new_subscriptions.stream_source.Key]] = None):
        super().__init__(last_keys)
        self.fa_key = fa_key
        self.username = username

    def current_state(self) -> List[hallo.modules.new_subscriptions.common_fa_key.FAKey.FAReader.FAWatch]:
    ...
    def item_to_key(
            self,
            item: hallo.modules.new_subscriptions.common_fa_key.FAKey.FAReader.FAWatch
