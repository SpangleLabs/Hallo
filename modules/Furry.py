...
class E621(Function):
    ...
    mHelpDocs = "Returns a random e621 result using the search you specify. Format: msg <tags>"
    ...
    def run(self,line,userObject,destinationObject=None):
        ...
        url = 'https://e621.net/post/index.json?tags='+lineClean+'%20order:random%20score:%3E0&limit=1'
